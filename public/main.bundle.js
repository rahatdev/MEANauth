...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1> MEAN Authentication App</h1>\n  <p> Welcome to our custom MEAN authentication application built from scratch</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n    <a class=\"btn btn-secondary\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A rock solid Node.js/Express server using Mongoose to organize modelsand query the database</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p>Angular-CLI to generate components, servrices and more. Local dev server and easy to initialize application</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Full featured authentication using JSON web tokens. Login and store user data.</p>\n  </div>\n</div>"
...
var LoginComponent = (function () {
    function LoginComponent(_flashMessage, _auth, _router) {
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this._auth.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this._flashMessage.show('You are now logged in.', { cssClass: 'alert-success', timeout: 3000 });
...
var NavbarComponent = (function () {
    function NavbarComponent(_auth, _flashMessage, _router) {
        this._auth = _auth;
        this._flashMessage = _flashMessage;
        this._router = _router;
    }
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._auth.getUser().subscribe(function (data) {
...
module.exports = "<br/>\n<h2 class=\"page-header\">Register</h2>\n<form (submit)=\"onRegisterSubmit()\"> \n  <div class=\"form-group\">\n    <label for=\"exampleInputEmail1\">Name</label>\n    <input type=\"text\" [(ngModel)]=\"name\" name=\"name\" class=\"form-control\" aria-describedby=\"emailHelp\" placeholder=\"Enter name\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"exampleInputPassword1\">Username</label>\n    <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control\" placeholder=\"Enter username\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"exampleInputEmail1\">Email address</label>\n    <input type=\"email\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\">\n    <small id=\"emailHelp\" class=\"form-text text-muted\">{{emailMessage}}</small>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"exampleInputPassword1\">Password</label>\n    <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\" placeholder=\"Password\">\n  </div>\n  <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n</form>"
...
var RegisterComponent = (function () {
    function RegisterComponent(_flashMessage, _validate, _auth, _router) {
        this._flashMessage = _flashMessage;
        this._validate = _validate;
        this._auth = _auth;
        this._router = _router;
        this.emailMessage = "We'll never share your email with anyone else.";
    }
